        ...
        <div className="animate-pulse flex space-x-4">
          <div className="flex-1 space-y-6 py-1">
            <div className="text-gray-200">
              Working on{" "}
              {count.tool.Tool != null ? count.tool.Tool : "Nothing :("}
            </div>
            <div className="space-y-3">
              <div className="gap-4">
                {count.tool.cmps != null
                  ? count.tool.cmps
                      .filter(function (e) {
                        return e;
                      })
      ...
      <div className="space-x-2 space-y-1 ml-5">
        <form className="flex sm:flex-row items-center h-auto ml-4">
          <input
            ...
            type="text"
            placeholder="Search"
            className="text-white bg-gray-800 shadow-lg w-screen h-10 mr-10"
            required
        ...
        <div className="space-x-2">
          <form className="flex sm:flex-row items-center h-auto">
            <button
              type="cat_head"
              className="bg-gray-700 w-20 h-10 m-2"
              onClick={(e) => {
                click(e, "Head");
              }}
            >
